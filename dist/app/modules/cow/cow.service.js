...
const createCow = (cow) => __awaiter(void 0, void 0, void 0, function* () {
    const isSellerExists = yield user_model_1.User.findOne({
        _id: cow.seller,
        role: 'seller',
    });
    if (!isSellerExists)
        throw new ApiError_1.default(httpStatus.NOT_FOUND, 'Seller Not Found!');
...
const updateCowById = (id, sellerId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist.seller.equals(sellerIdAsObjectId)) {
...
const deleteCowById = (cowId, sellerId) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cow_model_1.Cow.findOne({ _id: cowId });
    if (!isExist)
        throw new ApiError_1.default(httpStatus.NOT_FOUND, 'Cow Not Found');
    const ObjectId = mongoose_1.Types.ObjectId;
    const sellerIdAsObjectId = new ObjectId(sellerId);
    ...
    const cow = yield cow_model_1.Cow.findOneAndDelete({ _id: cowId }).populate('seller');
    return cow;
});
exports.CowService = {
    createCow,
